...
if __name__ == '__main__':
    ...
    # Prepare data.
    data_loader = load_data(data_path='/home/son/Downloads/image_retrieval_platform/static/corel-1k/',
                            batch_size=2,
                            shuffle=False,
                            transform='default',
                            )
    ...
    # Prepare model.
    model = load_model(pretrained_model='/home/son/Downloads/image_retrieval_platform/retrieval/models/net_best.pth', use_gpu=True)
